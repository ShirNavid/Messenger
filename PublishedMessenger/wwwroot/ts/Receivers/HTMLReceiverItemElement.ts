...
export abstract class HTMLReceiverItemElement extends HTMLElement {

    protected readonly _receiverList: HTMLReceiversListElement;
    protected readonly _accountData: AccountData;

    constructor(receiverList: HTMLReceiversListElement, accountData: AccountData) {
        super();
    ...
    private createReceiverItemElements(): void {
    ...
    private setReceiverItemEvents(): void {
        ...
        span.addEventListener("mouseleave", function (this: HTMLReceiverItemElement) {
            const isFixed = receiverItem.classList.contains("fixed");
            if (isFixed == false) {
