...
export class HTMLPagingButtonsGroupElement extends PagingButtonsGroupBase {
    ...
    setPagingButtons() {
        ...
        pagingButtonDatas.forEach(function (pagingButtonData) {
    ...
    getPagingButtonDatas() {
        const pagingButtonDatas = new Array();
...
//# sourceMappingURL=HTMLPagingButtonsGroupElement.js.map