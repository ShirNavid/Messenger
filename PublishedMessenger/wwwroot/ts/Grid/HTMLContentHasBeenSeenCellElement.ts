...
export class HTMLContentHasBeenSeenCellElement extends CellBase {
    ...
    private setEvent(): void {
        this.addEventListener("mouseover", function (this: HTMLContentHasBeenSeenCellElement, event: MouseEvent) {
            this._row.mouseOverEvent();
        });
        this.addEventListener("mouseleave", function (this: HTMLContentHasBeenSeenCellElement, event: MouseEvent) {
            this._row.mouseLeaveEvent();
        });
        this.addEventListener("mousedown", function (this: HTMLContentHasBeenSeenCellElement, event: MouseEvent) {
