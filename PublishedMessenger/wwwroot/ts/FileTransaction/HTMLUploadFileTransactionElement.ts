export class HTMLUploadFileTransactionElement extends HTMLElement {
    ...
    private setEvents(): void {
        ...
        this.addEventListener("mousedown", function (this: HTMLUploadFileTransactionElement, mouseEvent: MouseEvent) {
            const input = this.shadowRoot.querySelector("input");
            input.click();
        });

        this.addEventListener("mouseover", function (this: HTMLUploadFileTransactionElement, mouseEvent: MouseEvent) {
            this.style.backgroundColor = "rgb(213, 213, 213)";
        });

        this.addEventListener("mouseleave", function (this: HTMLUploadFileTransactionElement, mouseEvent: MouseEvent) {
            this.style.backgroundColor = "rgb(240, 240, 240)";
        });
    }

    private getWidth(text: string): string {
