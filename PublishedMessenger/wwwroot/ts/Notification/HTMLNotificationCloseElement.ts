...
export class HTMLNotificationCloseElement extends HTMLElement {
    ...
    constructor(notification: HTMLNotificationElement) {
        super();
    ...
    private setEvents(): void {
        ...
        this.addEventListener("mouseover", function (this: HTMLNotificationCloseElement, event: MouseEvent) {
            classList.add("red");
            if (classList.contains("gray")) {
                classList.remove("gray");
            }
        });
        this.addEventListener("mouseleave", function (this: HTMLNotificationCloseElement, event: MouseEvent) {
            classList.add("gray");
            if (classList.contains("red")) {
                classList.remove("red");
            }
        });
        this.addEventListener("mousedown", function (this: HTMLNotificationCloseElement, event: MouseEvent) {
