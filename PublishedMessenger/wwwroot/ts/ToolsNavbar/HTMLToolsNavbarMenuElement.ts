...
export class HTMLToolsNavbarMenuElement extends HTMLElement {
    ...
    private readonly _toolsNavbar: HTMLToolsNavbarElement;

    private _isListOpened: boolean;
    ...
    private setEvents(): void {
        ...
        this.addEventListener("mouseover", function (this: HTMLToolsNavbarMenuElement, event: MouseEvent) {
                this.style.backgroundColor = "rgb(250, 250, 250)";
                this.style.borderColor = "rgb(229, 229, 229)";
        });

        this.addEventListener("mouseleave", function (this: HTMLToolsNavbarMenuElement, event: MouseEvent) {
                this.style.borderColor = "transparent";
                this.style.backgroundColor = "transparent";
        });

        this.addEventListener("mousedown", function (this: HTMLToolsNavbarMenuElement, event: MouseEvent) {
